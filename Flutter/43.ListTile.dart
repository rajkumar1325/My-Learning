// IT IS JUST LIKE A CHAT-SCREEN OR CONTACT CHAT LIST
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    var ArrNames = ["Ram", "Ravan", "Ravana", "Rashmi", "Kaushik"]; //Array to pass
    ...
    return Scaffold(
      ...
      body: ListView.separated(itemBuilder: (context,indx){
          return ListTile(
            leading: Text('$indx'), //STARTING --- prints index number
            title: Text(ArrNames[indx]), //MIDDLE ---- prints dynamic from array.
            subtitle: Text("Number"),  //MIDDLE
            trailing: Icon(Icons.add), //END -------- flutter provide default icons
          );
        },
